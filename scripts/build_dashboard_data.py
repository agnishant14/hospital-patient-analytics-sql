...
ROWS = 50_000
BASE_YEAR = 2020
MONTHS = 72  # 2020-01 .. 2025-12
BILL_OFFSET = 3_000  # bills run 3,341..61,469, so the remainder fits a uint16
...
def main() -> None:
    ...
    for row_no, fact in enumerate(facts):
        ...
        weekend = visit_date.weekday() >= 5  # Python: Monday=0 .. Sunday=6
        ...
        # Age at the time of the visit, birthday-adjusted -- the same rule the
        # analysis layer uses, recomputed here so the dashboard bands match.
    ...
    with out.open("w", encoding="utf-8") as handle:
        handle.write("// Generated by scripts/build_dashboard_data.py -- do not edit.\n")
        handle.write("// Source: exports/*.csv. See that script for the column layout.\n")
